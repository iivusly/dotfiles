...
in
{
  programs.rmpc = {
    ...
    config = ''
      (
        theme: Some("stylix-generated"),
      )
    '';
  };

  xdg.configFile."rmpc/themes/stylix-generated.ron".text = ''
    ...
    (
      ...
      album_color: "#${colors.base0D}",
      artist_color: "#${colors.base0E}",
      title_color: "#${colors.base0B}",
      highlight_color: "#${colors.base0A}",
      primary_color: "#${colors.base05}",
      secondary_color: "#${colors.base03}",
      background_color: "#${colors.base00}",
      error_color: "#${colors.base08}",

      progress_bar_fill_color: "#${colors.base0D}",
      progress_bar_empty_color: "#${colors.base01}",
    )
  '';
}
